...
<html>
  <head>
	...
	<body>
		<form action="servlet/AdminServlet?method=upDate" method="post" name="form2" onsubmit="return validator(this)" 
>
			...
			<table class=editTable cellSpacing=1 cellPadding=0 width="100%"
				...
				<tr>
					...
					<td colspan="3" bgcolor="#FFFFFF">
						<input type="text" style="width: 145px" name="user_name"  value="${sessionScope.user.user_name }"
							readonly="readonly">
					...
					<td colspan="3" bgcolor="#FFFFFF">
						<input type="text"  style="width: 145px" name="user_age" maxlength="2"  valid="required|isNumber"  errmsg="员工年龄不能为空!|请输入正确的年龄!" value="${sessionScope.user.user_age }">
						&nbsp;
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan="3" bgcolor="#FFFFFF">
						<input type="text"  style="width: 145px" name="user_nation"
							value="${sessionScope.user.user_nation }">
						&nbsp;
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan="3" bgcolor="#FFFFFF">
						<input type="text"  style="width: 145px"       errmsg="请输入正确的座机号码!" name="user_num" value="${sessionScope.user.user_num }">
						&nbsp;
					</td>
					<td bgcolor="#FFFDF0">
						<div align="center">
					...
					<td colspan="3" bgcolor="#FFFFFF">
						<input type="password"  style="width: 145px"  maxlength="50"  name="user_pw"
							value="${sessionScope.user.user_pw }">
						&nbsp;
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan="3" bgcolor="#FFFFFF">
						<select name="department_id" id = "department_id"   style="width: 145px">
					...
					<td colspan="3" bgcolor="#FFFFFF">
						<select name="role_id" id = "role_id"   style="width: 145px">
				...
				<tr>
					...
					<td colspan="3" bgcolor="#FFFFFF">
						<input type="text"  style="width: 145px"     valid="isPhone"   errmsg="请输入正确的座机号码!" name="user_tel" value="${sessionScope.user.user_tel }">
						&nbsp;
					</td>
					<td bgcolor="#FFFDF0">
						<div align="center">
					...
					<td colspan="3" bgcolor="#FFFFFF">
						<input type="text"  style="width: 145px"  maxlength="50"  name="user_intest"
							value="${sessionScope.user.user_intest }">
						&nbsp;
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan="3" bgcolor="#FFFFFF">
						<input type="text" style="width: 145px"  valid="isNumber"   errmsg="请输入正确的工资卡号!"  maxlength="20"   name="user_bankcard"
							value="${sessionScope.user.user_bankcard }">
						&nbsp;
					</td>
					<td bgcolor="#FFFDF0">
						<div align="center">
					...
					<td colspan="3" bgcolor="#FFFFFF">
						<input type="text"  style="width: 145px" valid="regexp"  regexp="^1[3|4|5|8][0-9]\d{8}$"   errmsg="请输入正确的手机号码!" name="user_mobile"
							value="${sessionScope.user.user_mobile }">
						&nbsp;
					</td>
				...
				<tr>
					...
					<td colspan="3" bgcolor="#FFFFFF">
						<input type="text"  style="width: 145px"  valid="isIdCard"   errmsg="请输入正确的身份证号码!" name="user_idnum" value="${sessionScope.user.user_idnum }">
						&nbsp;
					</td>
					<td bgcolor="#FFFDF0">
						<div align="center">
					...
					<td colspan="3" bgcolor="#FFFFFF">
						<input type="text" readonly="readonly"  style="width: 145px" name="user_addtime"
							 value="${sessionScope.user.user_addtime }">
					</td>
				</tr>
				<tr>
					<td bgcolor="#FFFDF0">
					...
					<td colspan="3" bgcolor="#FFFFFF">
						<input type="text"  style="width: 145px"  maxlength="10" name="user_addman"
							disabled="disabled" value="${sessionScope.user.user_addman }">
						&nbsp;
					</td>
					<td bgcolor="#FFFDF0">
						<div align="center">
					...
					<td colspan="3" bgcolor="#FFFFFF">
						<input type="text" name="user_changeman"
							style="width: 145px" readonly="readonly" maxlength="20" value="${sessionScope.user.user_name }">
						&nbsp;
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan="3" bgcolor="#FFFFFF">
						<input type="text" style="width: 145px"  maxlength="50" name="user_email" value="${sessionScope.user.user_email }">
						&nbsp;
					</td>
					<td bgcolor="#FFFDF0">
						<div align="center">
